...
namespace SST {
    namespace MemHierarchy {
        ...
        public:
            SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(MESIInternalDirectory,
            "memHierarchy", "MESICacheDirectoryCoherenceController", SST_ELI_ELEMENT_VERSION(1,0,0),
...
/* Class definition */
            ...
            MESIInternalDirectory(Component *comp, Params &params) : CoherenceController(comp,
                                                                                         params) {}

            MESIInternalDirectory(ComponentId_t id, Params &params, Params &ownerParams)
                : CoherenceController(id, params, ownerParams) {
                params.insert(ownerParams);

                debug->debug(_INFO_,
                             "--------------------------- Initializing [MESI + Directory Controller] ... \n\n");
                ...
                stat_stateEvent_GetXResp_SMInv = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_FetchInvX_IS = registerStatistic<uint64_t>(
                    "stateEvent_FetchInvX_IS");
                stat_stateEvent_FetchInvX_IM = registerStatistic<uint64_t>(
                    "stateEvent_FetchInvX_IM");
                stat_stateEvent_FetchInvX_IB = registerStatistic<uint64_t>(
                    "stateEvent_FetchInvX_IB");
                stat_stateEvent_FetchInvX_SB = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_FetchInv_MInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchInv_MInv");
                stat_stateEvent_FetchInv_MInvX = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_FetchResp_MInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_MInv");
                stat_stateEvent_FetchResp_MInvX = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_MInvX");
                stat_stateEvent_FetchResp_SD = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_SD");
                stat_stateEvent_FetchResp_MD = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_MD");
                stat_stateEvent_FetchResp_SMD = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_SMD");
                stat_stateEvent_FetchResp_SInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_SInv");
                stat_stateEvent_FetchResp_SMInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_SMInv");
                stat_stateEvent_FetchResp_MI = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_MI");
                stat_stateEvent_FetchResp_SI = registerStatistic<uint64_t>(
                    "stateEvent_FetchResp_SI");
                stat_stateEvent_FetchXResp_MInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_MInv");
                stat_stateEvent_FetchXResp_MInvX = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_MInvX");
                stat_stateEvent_FetchXResp_SD = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_SD");
                stat_stateEvent_FetchXResp_MD = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_MD");
                stat_stateEvent_FetchXResp_SMD = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_SMD");
                stat_stateEvent_FetchXResp_SInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_SInv");
                stat_stateEvent_FetchXResp_SMInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_SMInv");
                stat_stateEvent_FetchXResp_MI = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_MI");
                stat_stateEvent_FetchXResp_SI = registerStatistic<uint64_t>(
                    "stateEvent_FetchXResp_SI");
                ...
                stat_stateEvent_AckInv_SMInv = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_AckInv_SBInv = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_FlushLine_IS = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_IS");
                stat_stateEvent_FlushLine_IM = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_IM");
                stat_stateEvent_FlushLine_SM = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_SM");
                stat_stateEvent_FlushLine_MInv = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_MInv");
                stat_stateEvent_FlushLine_MInvX = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_MInvX");
                stat_stateEvent_FlushLine_SInv = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_SInv");
                stat_stateEvent_FlushLine_SMInv = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_SMInv");
                stat_stateEvent_FlushLine_SD = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_SD");
                stat_stateEvent_FlushLine_MD = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_MD");
                stat_stateEvent_FlushLine_SMD = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_SMD");
                stat_stateEvent_FlushLine_MI = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_MI");
                stat_stateEvent_FlushLine_SI = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_SI");
                stat_stateEvent_FlushLine_IB = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_IB");
                stat_stateEvent_FlushLine_SB = registerStatistic<uint64_t>(
                    "stateEvent_FlushLine_SB");
                stat_stateEvent_FlushLineInv_I = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_I");
                stat_stateEvent_FlushLineInv_S = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_S");
                stat_stateEvent_FlushLineInv_M = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_M");
                stat_stateEvent_FlushLineInv_IS = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_IS");
                stat_stateEvent_FlushLineInv_IM = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_IM");
                stat_stateEvent_FlushLineInv_SM = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_SM");
                stat_stateEvent_FlushLineInv_MInv = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_MInv");
                stat_stateEvent_FlushLineInv_MInvX = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_MInvX");
                stat_stateEvent_FlushLineInv_SInv = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_SInv");
                stat_stateEvent_FlushLineInv_SMInv = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_SMInv");
                stat_stateEvent_FlushLineInv_SD = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_SD");
                stat_stateEvent_FlushLineInv_MD = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_MD");
                stat_stateEvent_FlushLineInv_SMD = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_SMD");
                stat_stateEvent_FlushLineInv_MI = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_MI");
                stat_stateEvent_FlushLineInv_SI = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_SI");
                stat_stateEvent_FlushLineResp_I = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineResp_I");
                stat_stateEvent_FlushLineResp_IB = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineResp_IB");
                stat_stateEvent_FlushLineResp_SB = registerStatistic<uint64_t>(
                ...
                stat_eventSent_FlushLineResp = registerStatistic<uint64_t>(
                ...
                if (!params.find<std::string>("prefetcher", "").empty()) {
                    ...
                    statPrefetchUpgradeMiss = registerStatistic<uint64_t>(
                ...
                if (protocol_) {
                    ...
                    stat_stateEvent_PutS_EInvX = registerStatistic<uint64_t>(
                    ...
                    stat_stateEvent_PutE_MInvX = registerStatistic<uint64_t>(
                    ...
                    stat_stateEvent_PutE_EInvX = registerStatistic<uint64_t>(
                    ...
                    stat_stateEvent_PutM_EInvX = registerStatistic<uint64_t>(
                    ...
                    stat_stateEvent_FetchInvX_E = registerStatistic<uint64_t>(
                        "stateEvent_FetchInvX_E");
                    stat_stateEvent_FetchInv_E = registerStatistic<uint64_t>(
                        "stateEvent_FetchInv_E");
                    stat_stateEvent_FetchInv_EInv = registerStatistic<uint64_t>(
                        "stateEvent_FetchInv_EInv");
                    stat_stateEvent_FetchInv_EInvX = registerStatistic<uint64_t>(
                        "stateEvent_FetchInv_EInvX");
                    stat_stateEvent_FetchInv_EI = registerStatistic<uint64_t>(
                        "stateEvent_FetchInv_EI");
                    stat_stateEvent_FetchInv_ED = registerStatistic<uint64_t>(
                        "stateEvent_FetchInv_ED");
                    stat_stateEvent_FetchResp_EInv = registerStatistic<uint64_t>(
                        "stateEvent_FetchResp_EInv");
                    stat_stateEvent_FetchResp_EInvX = registerStatistic<uint64_t>(
                        "stateEvent_FetchResp_EInvX");
                    stat_stateEvent_FetchResp_ED = registerStatistic<uint64_t>(
                        "stateEvent_FetchResp_ED");
                    stat_stateEvent_FetchResp_EI = registerStatistic<uint64_t>(
                        "stateEvent_FetchResp_EI");
                    stat_stateEvent_FetchXResp_EInv = registerStatistic<uint64_t>(
                        "stateEvent_FetchXResp_EInv");
                    stat_stateEvent_FetchXResp_EInvX = registerStatistic<uint64_t>(
                        "stateEvent_FetchXResp_EInvX");
                    stat_stateEvent_FetchXResp_ED = registerStatistic<uint64_t>(
                        "stateEvent_FetchXResp_ED");
                    stat_stateEvent_FetchXResp_EI = registerStatistic<uint64_t>(
                        "stateEvent_FetchXResp_EI");
                    stat_stateEvent_AckInv_EInv = registerStatistic<uint64_t>(
                        "stateEvent_AckInv_EInv");
                    stat_stateEvent_AckInv_EI = registerStatistic<uint64_t>("stateEvent_AckInv_EI");
                    stat_stateEvent_FlushLine_E = registerStatistic<uint64_t>(
                        "stateEvent_FlushLine_E");
                    stat_stateEvent_FlushLine_EInv = registerStatistic<uint64_t>(
                        "stateEvent_FlushLine_EInv");
                    stat_stateEvent_FlushLine_EInvX = registerStatistic<uint64_t>(
                        "stateEvent_FlushLine_EInvX");
                    stat_stateEvent_FlushLine_ED = registerStatistic<uint64_t>(
                        "stateEvent_FlushLine_ED");
                    stat_stateEvent_FlushLine_EI = registerStatistic<uint64_t>(
                        "stateEvent_FlushLine_EI");
                    stat_stateEvent_FlushLineInv_E = registerStatistic<uint64_t>(
                        "stateEvent_FlushLineInv_E");
                    stat_stateEvent_FlushLineInv_EInv = registerStatistic<uint64_t>(
                        "stateEvent_FlushLineInv_EInv");
                    stat_stateEvent_FlushLineInv_EInvX = registerStatistic<uint64_t>(
                        "stateEvent_FlushLineInv_EInvX");
                    stat_stateEvent_FlushLineInv_ED = registerStatistic<uint64_t>(
                        "stateEvent_FlushLineInv_ED");
                    stat_stateEvent_FlushLineInv_EI = registerStatistic<uint64_t>(
                        "stateEvent_FlushLineInv_EI");
...
/* Event handlers */
            ...
            CacheAction handleEviction(CacheLine *replacementLine, string origRqstr,
                                       bool fromDataCache);
            ...
            CacheAction handleReplacement(MemEvent *event, CacheLine *dirLine, MemEvent *reqEvent,
                                          bool replay);

            /** Process invalidation requests - Inv, FetchInv, FetchInvX */
            CacheAction handleInvalidationRequest(MemEvent *event, CacheLine *dirLine,
                                                  MemEvent *collisionEvent, bool replay);

            /** Process responses - GetSResp, GetXResp, FetchResp */
            CacheAction handleResponse(MemEvent *responseEvent, CacheLine *dirLine,
...
/* Private event handlers */
            ...
            CacheAction handleFlushLineRequest(MemEvent *event, CacheLine *dirLine,
                                               MemEvent *origReq, bool replay);

            /** Handle FlushLineInv request. */
            CacheAction handleFlushLineInvRequest(MemEvent *event, CacheLine *dirLine,
                                                  MemEvent *origReq, bool replay);

            /** Handle Inv */
            CacheAction handleInv(MemEvent *event, CacheLine *dirLine, bool replay,
                                  MemEvent *collisionEvent);

            /** Handle ForceInv */
            CacheAction handleForceInv(MemEvent *event, CacheLine *dirLine, bool replay,
                                       MemEvent *collisionEvent);

            /** Handle Fetch */
            CacheAction handleFetch(MemEvent *event, CacheLine *dirLine, bool replay,
                                    MemEvent *collisionEvent);

            /** Handle FetchInv */
            CacheAction handleFetchInv(MemEvent *event, CacheLine *dirLine, bool replay,
                                       MemEvent *collisionEvent);

            /** Handle FetchInvX */
            CacheAction handleFetchInvX(MemEvent *event, CacheLine *dirLine, bool replay,
                                        MemEvent *collisionEvent);

            /** Process GetSResp/GetXResp */
            CacheAction handleDataResponse(MemEvent *responseEvent, CacheLine *dirLine,
                                           MemEvent *reqEvent);

            /** Handle FetchResp */
            CacheAction handleFetchResp(MemEvent *responseEvent, CacheLine *dirLine,
                                        MemEvent *reqEvent);

            /** Handle Ack */
            CacheAction handleAckInv(MemEvent *responseEvent, CacheLine *dirLine,
                                     MemEvent *reqEvent);

/* Private methods for sending events */
            void sendResponseDown(MemEvent *event, CacheLine *dirLine, std::vector <uint8_t> *data,
                                  bool dirty, bool replay);
            ...
            void sendWritebackFromMSHR(Command cmd, CacheLine *dirLine, string origRqstr,
            ...
            bool invalidateSharersExceptRequestor(CacheLine *dirLine, string rqstr,
                                                  string origRqstr, bool replay, bool checkFetch);

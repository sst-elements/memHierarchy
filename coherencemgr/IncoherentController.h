...
namespace SST {
    namespace MemHierarchy {
        ...
        public:
            SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(IncoherentController,
            "memHierarchy", "IncoherentController", SST_ELI_ELEMENT_VERSION(1,0,0),
...
/* Class definition */
            ...
            IncoherentController(SST::Component *comp, Params &params) : CoherenceController(comp,
                                                                                             params) {}

            IncoherentController(SST::ComponentId_t id, Params &params, Params &ownerParams)
                : CoherenceController(id, params, ownerParams) {
                params.insert(ownerParams);
                debug->debug(_INFO_,
                             "--------------------------- Initializing [Incoherent Controller] ... \n\n");
...
/* Event handlers */
            ...
            CacheAction handleEviction(CacheLine *_wbCacheLine, string _origRqstr,
            ...
            CacheAction handleInvalidationRequest(MemEvent *event, CacheLine *cacheLine,
                                                  MemEvent *collisonEvent, bool replay);

            /** Process responses - GetSResp, GetXResp, FetchResp */
            CacheAction handleResponse(MemEvent *_responseEvent, CacheLine *cacheLine,
                                       MemEvent *_origRequest);

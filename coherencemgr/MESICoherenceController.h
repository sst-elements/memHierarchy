...
namespace SST {
    namespace MemHierarchy {
        ...
        public:
            SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(MESIController,
            "memHierarchy", "MESICoherenceController", SST_ELI_ELEMENT_VERSION(1,0,0),
...
/* Class definition */
            ...
            MESIController(SST::Component *comp, Params &params) : CoherenceController(comp,
                                                                                       params) {}

            MESIController(SST::ComponentId_t id, Params &params, Params &ownerParams)
                ...
                stat_stateEvent_FetchInvX_MInv = registerStatistic<uint64_t>(
                    "stateEvent_FetchInvX_MInv");
                stat_stateEvent_FetchInvX_MInvX = registerStatistic<uint64_t>(
                    "stateEvent_FetchInvX_MInvX");
                stat_stateEvent_FetchInvX_MI = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_FetchInv_SInv = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_FetchXResp_I = registerStatistic<uint64_t>(
                ...
                stat_stateEvent_AckInv_MInvX = registerStatistic<uint64_t>(
                    "stateEvent_AckInv_MInvX");
                ...
                stat_stateEvent_FlushLineInv_IB = registerStatistic<uint64_t>(
                    "stateEvent_FlushLineInv_IB");
                stat_stateEvent_FlushLineInv_SB = registerStatistic<uint64_t>(
                ...
                if (protocol_) {
                    ...
                    stat_stateEvent_FetchInvX_EInv = registerStatistic<uint64_t>(
                        "stateEvent_FetchInvX_EInv");
                    stat_stateEvent_FetchInvX_EInvX = registerStatistic<uint64_t>(
                        "stateEvent_FetchInvX_EInvX");
                    stat_stateEvent_FetchInvX_EI = registerStatistic<uint64_t>(
                        "stateEvent_FetchInvX_EI");
                    ...
                    stat_stateEvent_AckInv_EInvX = registerStatistic<uint64_t>(
                        "stateEvent_AckInv_EInvX");
...
/* Event handlers */
            ...
            CacheAction handleEviction(CacheLine *wbCacheLine, string origRqstr,
                                       bool ignoredParam = false);
            ...
            CacheAction handleReplacement(MemEvent *event, CacheLine *cacheLine, MemEvent *reqEvent,
                                          bool replay);

            /** Process invalidation requests - Inv, FetchInv, FetchInvX */
            CacheAction handleInvalidationRequest(MemEvent *event, CacheLine *cacheLine,
                                                  MemEvent *collisionEvent, bool replay);

            /** Process responses - GetSResp, GetXResp, FetchResp */
            CacheAction handleResponse(MemEvent *responseEvent, CacheLine *cacheLine,
...
/* Private event handlers */
            ...
            CacheAction handleFlushLineInvRequest(MemEvent *event, CacheLine *cacheLine,
                                                  MemEvent *reqEvent, bool replay);
            ...
            CacheAction handlePutSRequest(MemEvent *event, CacheLine *cacheLine,
                                          MemEvent *reqEvent);
            ...
            /** Handle FetchInv */
            CacheAction handleFetchInv(MemEvent *event, CacheLine *cacheLine,
                                       MemEvent *collisionEvent, bool replay);

            /** Handle FetchInvX */
            CacheAction handleFetchInvX(MemEvent *event, CacheLine *cacheLine,
                                        MemEvent *collisionEvent, bool replay);

            /** Process GetSResp/GetXResp.  Update the cache line */
            CacheAction handleDataResponse(MemEvent *responseEvent, CacheLine *cacheLine,
                                           MemEvent *reqEvent);

            /** Handle FetchResp */
            CacheAction handleFetchResp(MemEvent *responseEvent, CacheLine *cacheLine,
                                        MemEvent *reqEvent);

            /** Handle Ack */
            CacheAction handleAckInv(MemEvent *responseEvent, CacheLine *cacheLine,
                                     MemEvent *reqEvent);
...
/* Private methods for sending events */
            ...
            bool invalidateSharersExceptRequestor(CacheLine *cacheLine, string rqstr,

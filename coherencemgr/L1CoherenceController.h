...
/* Element Library Info */
            SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(L1CoherenceController,
            "memHierarchy", "L1CoherenceController", SST_ELI_ELEMENT_VERSION(1,0,0),
...
/* Class definition */
            ...
            L1CoherenceController(Component *comp, Params &params) : CoherenceController(comp,
                                                                                         params) {}

            L1CoherenceController(ComponentId_t id, Params &params, Params &ownerParams)
                ...
                // Register statistics
                stat_eventStalledForLock = registerStatistic<uint64_t>(
            ...
            CacheAction handleReplacement(MemEvent *event, CacheLine *cacheLine,
                                          MemEvent *origRequest, bool replay);
            ...
            uint64_t sendResponseUp(MemEvent *event, vector <uint8_t> *data, bool replay,
                                    uint64_t baseTime, bool atomic = false);
...
/* Miscellaneous */
        ...
        private:
            ...
            void handleDataResponse(MemEvent *responseEvent, CacheLine *cacheLine,
                                    MemEvent *reqEvent);
            ...
            void forwardFlushLine(Addr baseAddr, Command cmd, string origRqstr,
                                  CacheLine *cacheLine);

            /** Send response to a flush request */
            void sendFlushResponse(MemEvent *requestEvent, bool success, uint64_t baseTime,
                                   bool replay);

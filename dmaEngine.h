...
public:
  ...
  SST_ELI_REGISTER_COMPONENT(DMAEngine, "memHierarchy", "DMAEngine",
                             SST_ELI_ELEMENT_VERSION(1, 0, 0), "DMA Engine",
  ...
  SST_ELI_DOCUMENT_PORTS({"netLink",
                          "Network Link",
...
private:
  struct Request {
    ...
    Request(DMACommand *cmd) : command(cmd) {}
  };

...
/*------------------------------- Simple Backend ------------------------------- */
RequestReorderSimple::RequestReorderSimple(Component *comp, Params &params) : SimpleMemBackend(comp,
                                                                                               params) {
    build(params);
}

RequestReorderSimple::RequestReorderSimple(ComponentId_t id, Params &params) : SimpleMemBackend(id,
                                                                                                params) {
    build(params);
}

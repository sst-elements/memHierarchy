...
public:
  ...
  SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
      ExtMemBackendConvertor, "memHierarchy", "extMemBackendConvertor",
      SST_ELI_ELEMENT_VERSION(1, 0, 0),
      "Converts MemEventBase* for an ExtMemBackend - passes additional opcode "
      "information",
  ...
  /* Class definition */
  ExtMemBackendConvertor(ComponentId_t id, Params &params, MemBackend *backend,
                         uint32_t reqWidth);

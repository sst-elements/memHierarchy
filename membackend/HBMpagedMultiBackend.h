...
namespace SST {
    namespace MemHierarchy {
        ...
        struct HBMpageInfo {
            ...
            // stats
            typedef enum {
                LT_NEG_ONE, NEG_ONE, ZERO, ONE, GT_ONE, LAST_CASE
            } AcCases;
            ...
            HBMpageInfo() : pageAddr(0), touched(0), inFast(0), lastTouch(0), lastRef(0),
                            scanLeng(0),
...
/* Element Library Info */
            SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(HBMpagedMultiMemory,
            "memHierarchy", "HBMpagedMultiMemory", SST_ELI_ELEMENT_VERSION(1,0,0),

...
/* Element Library Info */
            SST_ELI_REGISTER_COMPONENT(Sieve,
            "memHierarchy", "Sieve", SST_ELI_ELEMENT_VERSION(1,0,0),
            ...
            {
                "alloc_link_%(port)d", "Ports connected to the CPUs' allocation/free notification ports", {
...
/* Begin class definition */
            ...
            Addr toBaseAddr(Addr addr) {
                Addr baseAddr =
                    (addr) & ~(cacheArray_->getLineSize() - 1);  //Remove the block offset bits
                return baseAddr;
            }

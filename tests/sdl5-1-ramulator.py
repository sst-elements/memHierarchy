...
link_c0_l1cache_l2cache_link.connect((comp_c0_l1cache, "low_network_0", "10000ps"),
...
link_c1_l1cache_l2cache_link.connect((comp_c1_l1cache, "low_network_0", "10000ps"),
...
link_n0_l2cache_l3cache.connect((comp_n0_l2cache, "low_network_0", "10000ps"),
                                (comp_n2_bus, "high_network_0", "10000ps"))
...
link_c2_l1cache_l2cache_link.connect((comp_c2_l1cache, "low_network_0", "10000ps"),
                                     (comp_n1_bus, "high_network_0", "10000ps"))
...
link_c3_l1cache_l2cache_link.connect((comp_c3_l1cache, "low_network_0", "10000ps"),
                                     (comp_n1_bus, "high_network_1", "10000ps"))
...
link_n1_l2cache_l3cache.connect((comp_n1_l2cache, "low_network_0", "10000ps"),
                                (comp_n2_bus, "high_network_1", "10000ps"))

...
/* Element Library Info */
            SST_ELI_REGISTER_COMPONENT(trivialCPU,
            "memHierarchy", "trivialCPU", SST_ELI_ELEMENT_VERSION(1,0,0),
            ...
            SST_ELI_DOCUMENT_PORTS( {
                "mem_link", "Connection to cache", {"memHierarchy.MemEventBase"}
            } )
...
/* Begin class definition */
            ...
            void finish() {
                out.verbose(CALL_INFO, 1, 0, "TrivialCPU %s Finished after %"
                PRIu64
                " issued reads, %"
                PRIu64
                " returned (%"

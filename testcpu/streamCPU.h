...
public:
  ...
  SST_ELI_REGISTER_COMPONENT(streamCPU, "memHierarchy", "streamCPU",
                             SST_ELI_ELEMENT_VERSION(1, 0, 0),
                             "Simple demo streaming CPU for testing",
  ...
  void init();
  void finish() {
    out.output("streamCPU Finished after %" PRIu64 " issued reads, %" PRIu64
               " returned\n",

...
#define _L2_                                                                   \
  CALL_INFO, 2, 0 // Important messages:  incoming requests, state changes, etc
#define _L3_                                                                   \
  CALL_INFO, 3, 0 // Important messages:  incoming requests, state changes, etc
#define _L4_                                                                   \
  CALL_INFO, 4,                                                                \
      0 // Important messages:  send request, forward request, send response
